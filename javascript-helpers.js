...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MarkdownRenderer = exports.markdown = undefined;
	...
	var MarkdownRenderer = exports.MarkdownRenderer = function () {
	  ...
	  function MarkdownRenderer() {
	    ...
	    this._options = (0, _underscore.clone)(options);

	    if ((0, _underscore.isUndefined)(options.safe)) {
	      this._options.safe = true;
	    }
	    if ((0, _underscore.isUndefined)(options.smart)) {
	  ...
	  _createClass(MarkdownRenderer, [{
	    key: 'render',
	    value: function render(mdText) {
	      var reader = new _commonmark2.default.Parser();
	      var writer = new _commonmark2.default.HtmlRenderer(this._options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__e( getActive('volunteer') ) +
	'">\n            <a href="' +
	__e( getUrl('volunteer', activeOrganisation) ) +
	'">\n              <span class="menu-title">Volunteers</span>\n            </a>\n          </li>\n        ';
	 } ;
	__p += '\n\n        ';
	 if (feature_enabled('sponsors')) { ;
	__p += '\n          <li class="nav-sponsorship ' +
	__e( getActive('sponsor') ) +
	'">\n            <a href="' +
	__e( getUrl('sponsor', activeOrganisation) ) +
	'">\n              <span class="menu-title">Sponsors</span>\n            </a>\n          </li>\n        ';
	 } ;
	__p += '\n\n        ';
	 if (feature_enabled('lettings')) { ;
	__p += '\n          <li class="nav-admin ' +
	__e( getActive('letting') ) +
	'">\n            <a href="' +
	__e( getUrl('letting', activeOrganisation) ) +
